...
export const TokensCard = () => {
    ...
    <div className="w-[97%]  bg-clip-padding bg-[#171717] border border-blue-600/25 bg-opacity-60 md:w-880 items-center rounded-3xl ml-auto mr-auto h-[]">
        <div className="w-[100%] flex text-md text-center py-3 px-4 h-10 mb-auto rounded-t-3xl bg-white/5">
            ...
            <div className=" ml-auto mr-auto w-[35%]  text-center ">Token</div>
        ...
        <div  className="w-[100%] text-center  text-md flex py-3 px-4 border border-blue-600/15 h-12 mb-auto">
            ...
            <div className=" ml-auto mr-auto w-[35%] cursor-pointer text-center">{item.attributes.name}</div>
            <div className=" ml-2 lg:ml-3 w-[30%] text-center">{`$${Intl.NumberFormat(language, {notation: "compact"}).format(34)}`}</div>
            <div className=" ml-2 lg:ml-3 w-[30%] text-center">{`$${Intl.NumberFormat(language, {notation: "compact"}).format(444444444)}`}</div>
            <div className=" ml-2 lg:ml-3 w-[30%] text-center">{`$${Intl.NumberFormat(language, {notation: "compact"}).format(344444)}`}</div>
        </div>
        )} />
    </div> 
       <p className="text-center py-2 px-3 text-xl">No Data Coming Soon</p> */} 
        <p className="text-center py-2 px-3 text-xl">No Token Data Coming Soon</p>
